...
void CCLAS_View::OnRButtonDown(UINT nFlags, CPoint point)
{
...
void CCLAS_View::OnLButtonDown(UINT nFlags, CPoint point)
{
...
BOOL CCLAS_View::RectCrossingRect(int recLeft1,int recTop1,int recRight1,int recBottom1,int recLeft,int recTop,int recRight,int recBottom)
{
...
BOOL CCLAS_View::LineCrossingRect(int x1,int y1,int x2,int y2,int recLeft,int recTop,int recRight,int recBottom)
{
...
void CCLAS_View::Hilight_AllCaptured_Figs() 
{
	if(m_numCaptured>0){
		int clm, row;
		CFigure *pFig;
...
void CCLAS_View::Hilight_OneCapturedFig(CFigure *pFig) 
{
	m_DC[0].SelectObject(m_ORANGE2);
...
void CCLAS_View::UnHilight_OneCaptured(CFigure *pFig) 
{
...
void CCLAS_View::OnContextMenu(CWnd* pWnd, CPoint point)
{
	CMenu menu;
...
void CCLAS_View::WhichFigure(CPoint point) 
{
...
void CCLAS_View::DrawOneFigure(CFigure *pFig, int isToHighlight) 
{
	CClientDC objDC(this);
