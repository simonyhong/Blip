...
void CVISView::LinearColorMix(COLORREF RGB_array[],int arraySize) 
{		
...
void CVISView::LinearColorMix_adjusted(COLORREF RGB_array[],int arraySize) 
{
	int i;
...
void CVISView::CosineColorMix(COLORREF RGB_array[],int arraySize) 
{		
	double Ker;
...
void CVISView::MyOriginalColorMix(COLORREF RGB_array[],int arraySize) 
{	
	int R,G,B;
	double SqDist;
	COLORREF RGB;
...
void CVISView::ColorLegend(CDC *pDC, CFigure *pFig) 
{	
...
void CVISView::FromScrnToDataCoordinate(int x, int y, float &DataX, float &DataY, CFigure *pFig) 
{
