...
double CVISView::Mean(double *Array, int N)
{
	int i;
	double mean=0;
...
double CVISView::Mean(float *Array, int N)
{
	int i;
	double mean=0;
...
double CVISView::Mean(int *Array, int N)
{
	int i;
	double mean=0;
...
double CVISView::SD_GivenM(double *Array, int N,double mean)
{
	int i;
	double SD=0;
...
double CVISView::SD_GivenM(float *Array, int N,double mean)
{
	int i;
	double SD=0;
...
double CVISView::SD_GivenM(int *Array, int N, double mean)
{
	int i;
	double SD=0;
...
double CVISView::Mean_OnlyPositive(double *Array, int N)
{
	int i,n=0;
	double mean=0;
...
double CVISView::SD_GivenM_OnlyPositive(double *Array, int N,double mean)
{
	int i,n=0;
	double SD=0;
...
void CVISView::Gaussian_WhiteNoise_0to1(double noise[], int numSamples, double Mean, double Sig) 
{	
	srand(time(0));
...
double CVISView::GenHist_fromMinimum(double Data[],int dataSize, int Hist[], int binNum, double binWidth) 
{
	int i, idx;
...
double CVISView::box_muller(double m, double s)	
{
	double x1, x2, w, y1;
	static double y2;
...
void CVISView::BubbleSort(int x[], int count)
{
	int i, j, tempID;
...
void CVISView::BubbleSort(int x[], int count, int prvOrder[])
{
...
void CVISView::Sort_inAscendingOrder(int x[], int count, int OrderX[])
{
