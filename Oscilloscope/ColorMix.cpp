...
void COscilloscopeView::LinearColorMix(COLORREF RGB_array[],int arraySize) 
{		
...
void COscilloscopeView::LinearColorMix_adjusted(COLORREF RGB_array[],int arraySize) 
{
	int i;
...
void COscilloscopeView::CosineColorMix(COLORREF RGB_array[],int arraySize) 
{		
	double Ker;
...
void COscilloscopeView::MyOriginalColorMix(COLORREF RGB_array[],int arraySize) 
{	
	int R,G,B;
	double SqDist;
	COLORREF RGB;
...
void COscilloscopeView::ColorLegend(CDC *pDC, CFigure *pFig) 
{	
...
void COscilloscopeView::FromScrnToDataCoordinate(int x, int y, float &DataX, float &DataY, CFigure *pFig) 
{
