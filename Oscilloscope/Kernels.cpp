...
double COscilloscopeView::Kernel_2D(double KerSum, double Sigma, double RangeX)
{
...
//It calculates the constant of the Gaussian kernel.
double COscilloscopeView::Kernel_1D(double KerSum, double Sigma, double RangeX)
{
	double sigSq=Sigma*Sigma, rangeXSq=RangeX*RangeX, SqDist, Sum; 
...
int COscilloscopeView::MakeGssKernel_1D(float KrVal[], int sizeOfKer, int KerFieldX[], double KerSum, double Sigma, double RangeX)
{
