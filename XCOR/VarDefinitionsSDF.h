...
#define VERSION_NUM_OF_XCORTER_PLOTTER 1.0
...
#define ECODE_MUST_EXIEST			0
#define ECODE_MUST_NOT_EXIEST		1
#define ONE_OF_ECODES_MUST_EXIEST	2
...
#define REDRAW_ALL_CONTENT	7	
#define REDRAW_ONE_FIG_CONTENT	8	

//#### File stuff
#define TOREAD		1	
#define NOT_TOREAD		0	

#define HOW_MANY_TRLS_TO_DISP 40 //The number of rasters displayed in a figure
#define MAX_TRLS_STORED_IN_FIG	(1000)//Maximum trials to be stored in m_Fig[][][]


#define MAX_CONTINUOUS_SDF_ms	10000//10 second	
