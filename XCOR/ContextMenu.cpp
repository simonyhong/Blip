...
void CXCOR_View::OnContextMenu(CWnd* pWnd, CPoint point)
{
...
void CXCOR_View::OnDelete_the_Rest_Figs()
{
	if(m_numCaptured==0){AfxMessageBox("Nothing has been selected ==> Try again", MB_OK); return;}
	int clm,row;
	CFigure *pFig;
...
void CXCOR_View::EliminateExcluded()
{
	int clm,row;
