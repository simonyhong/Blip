...
double CXCOR_View::Mean(double *Array, int N)
{
	int i;
	double mean=0;
...
double CXCOR_View::Mean(float *Array, int N)
{
	int i;
	double mean=0;
...
double CXCOR_View::Mean(int *Array, int N)
{
	int i;
	double mean=0;
...
double CXCOR_View::SD_GivenM(double *Array, int N,double mean)
{
	int i;
	double SD=0;
...
double CXCOR_View::SD_GivenM(float *Array, int N,double mean)
{
	int i;
	double SD=0;
...
double CXCOR_View::SD_GivenM(int *Array, int N, double mean)
{
	int i;
	double SD=0;
...
double CXCOR_View::Mean_OnlyPositive(double *Array, int N)
{
	int i,n=0;
	double mean=0;
...
double CXCOR_View::SD_GivenM_OnlyPositive(double *Array, int N,double mean)
{
	int i,n=0;
	double SD=0;
...
void CXCOR_View::Gaussian_WhiteNoise_0to1(double noise[], int numSamples, double Mean, double Sig) 
{	
	srand(time(0));
...
double CXCOR_View::GenHist_fromMinimum(double Data[],int dataSize, int Hist[], int binNum, double binWidth) 
{
	int i, idx;
...
double CXCOR_View::box_muller(double m, double s)	
{
	double x1, x2, w, y1;
	static double y2;
...
void CXCOR_View::BubbleSort(int x[], int count)
{
	int i, j, tempID;
...
void CXCOR_View::BubbleSort(int x[], int count, int prvOrder[])
{
...
void CXCOR_View::Sort_inAscendingOrder(int x[], int count, int OrderX[])
{
