...
//
//--------------------------------------------------------
void CAntsView::OpenSharedMemory()
{
...
//
//--------------------------------------------------------
void CAntsView::DestroySharedMemoryArea ()
{
...
//
//--------------------------------------------------------
void CAntsView::WriteOnSharedMemory(int data, int position)
{
...
//
//--------------------------------------------------------
void CAntsView::ReadFromSharedMemory(int *data, int position)
{
