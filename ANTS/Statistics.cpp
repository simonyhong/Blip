...
double CAntsView::Mean(double *Array, int N)
{
	int i;
	double mean=0;
...
double CAntsView::Mean(float *Array, int N)
{
	int i;
	double mean=0;
...
double CAntsView::Mean(int *Array, int N)
{
	int i;
	double mean=0;
...
double CAntsView::SD_GivenM(double *Array, int N,double mean)
{
	int i;
	double SD=0;
...
double CAntsView::SD_GivenM(float *Array, int N,double mean)
{
	int i;
	double SD=0;
...
double CAntsView::SD_GivenM(int *Array, int N, double mean)
{
	int i;
	double SD=0;
...
double CAntsView::Mean_OnlyPositive(double *Array, int N)
{
	int i,n=0;
	double mean=0;
...
double CAntsView::SD_GivenM_OnlyPositive(double *Array, int N,double mean)
{
	int i,n=0;
	double SD=0;
...
void CAntsView::Gaussian_WhiteNoise_0to1(double noise[], int numSamples, double Mean, double Sig) 
{	
	srand(time(0));
...
double CAntsView::GenHist_fromMinimum(double Data[],int dataSize, int Hist[], int binNum, double binWidth) 
{
	int i, idx;
...
double CAntsView::box_muller(double m, double s)	
{
	double x1, x2, w, y1;
	static double y2;
...
void CAntsView::BubbleSort(int x[], int count)
{
	int i, j, tempID;
...
void CAntsView::BubbleSort(int x[], int count, int prvOrder[])
{
...
void CAntsView::Sort_inAscendingOrder(int x[], int count, int OrderX[])
{
