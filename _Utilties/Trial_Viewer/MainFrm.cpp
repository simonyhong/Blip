...
BOOL CMainFrame::PreCreateWindow(CREATESTRUCT& cs)
{
	...
	//  the CREATESTRUCT cs
    cs.cy = ::GetSystemMetrics(SM_CYSCREEN) / 2; //Specifies the width of the new window.
    cs.cx = ::GetSystemMetrics(SM_CXSCREEN) / 2; //Specifies the height of the new window.
	...
	char nameOfWindow[100]; sprintf(nameOfWindow,"Babooo");
	cs.lpszName=nameOfWindow; 
