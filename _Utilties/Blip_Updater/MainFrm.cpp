...
BOOL CMainFrame::PreCreateWindow(CREATESTRUCT& cs)
{
	...
	//  the CREATESTRUCT cs
    cs.cy = 150;//::GetSystemMetrics(SM_CYSCREEN) / 2; //Specifies the width of the new window.
    cs.cx = 300;//::GetSystemMetrics(SM_CXSCREEN) / 2; //Specifies the height of the new window.
